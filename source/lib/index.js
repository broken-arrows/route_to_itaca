...
(function () {
  ...
  var electionWidgets = hasModule
    ? require("./election_widgets.js")
    : window.RTI_ELECTION_WIDGETS;
  ...
  var lib = Object.assign({}, catEngine, allegiances, brief, government, electionWidgets);
